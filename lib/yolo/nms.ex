defmodule YOLO.NMS do
  ...
  def nms(tensor, prob_threshold, _nms_iou_threshold) do
    tensor
    |> filter_predictions(prob_threshold)

    # results sorted desc by probability?
    # |> group by class, they should be sorted by probability
  ...
  def filter_predictions(output_nx, prob_threshold) do
